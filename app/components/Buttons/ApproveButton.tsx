...
export function ApproveButton({ children }: ButtonProps) {
    return (
        <button
            className=
            'flex h-10 items-center rounded-md bg-approve px-4 font-medium font-button text-white transition-colors hover:bg-green-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500 active:bg-green-600 aria-disabled:cursor-not-allowed aria-disabled:opacity-50'
        >
