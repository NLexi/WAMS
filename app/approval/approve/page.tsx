...
export default function ApprovalApprove() {
        ...
        <div>
            ...
            <div className="flex flex-col py-[8%] px-[25%] items-center">
                ...
                <div className="flex flex-row gap-2 justify-center items-center">
                    <div className="flex bg-[#D6FAD7] rounded-full w-10 h-10 justify-center items-center"><IconCircleCheck className="text-[#17CA1D]" /></div>
                    <p className="text-base">RQ2305000082-I have been approved</p>
                </div>
                <div className="border-[1px] border-[#8092A0] container flex flex-col m-auto p-5 w-[80%] h-[20%] gap-1 mt-14">
