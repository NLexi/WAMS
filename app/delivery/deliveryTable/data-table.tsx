        ...
        <div>
            <div className="mx-auto flex py-4 justify-end">
                <div className="flex item-center">
                    <IconSearch className="relative left-7 top-4 transform -translate-y-1/2" />
                    <Input
            ...
            <div className="mx-auto flex justify-end gap-2 p-2">
                <Button onClick={() => table.previousPage} variant="tertiary">Prev Page</Button>
                <Button onClick={() => table.nextPage} variant="tertiary">Next Page</Button>
            </div>
        </div>
    )
}
